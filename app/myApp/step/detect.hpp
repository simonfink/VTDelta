...
// 	std::cout << "detect to position: " << controlSys.pathPlanner.getPosOut().getSignal().getValue() << std::endl;
	while (!controlSys.pathPlanner.posReached()) {
// 		std::cout << "detect to: " << controlSys.pathPlanner.getPosOut().getSignal().getValue() << std::endl;
// 		std::cout << "detecting: " << controlSys.directKin.getOut().getSignal().getValue() << std::endl;
		usleep(100000);
		std::this_thread::yield();
	}
// 	std::cout << "detect to final: " << controlSys.pathPlanner.getPosOut().getSignal().getValue() << std::endl;
// 	std::cout << "detecting final: " << controlSys.directKin.getOut().getSignal().getValue() << std::endl;
      };
