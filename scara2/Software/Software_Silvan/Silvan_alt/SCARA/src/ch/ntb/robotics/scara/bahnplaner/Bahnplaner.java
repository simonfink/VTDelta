...
public class Bahnplaner {

	private double[] amax = new double[2];			// max linear acceleration		25 m/s^2
	private double[] vmax = new double[2];				// max linear velocity			5 m/s
	...
	/**
	*	object-constructor; calculates the times for the Bahnplaner once
	*/
	public Bahnplaner(double[] vmax, double[] amax) {
		this.vmax = vmax;
		this.amax = amax;
	}
	...
	*/
	public void calcPath(double[] start, double[] ende, double Ts) {
		this.dt = Ts;
		this.ende = ende;
