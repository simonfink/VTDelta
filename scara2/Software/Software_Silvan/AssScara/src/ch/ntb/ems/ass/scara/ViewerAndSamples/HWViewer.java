...
public class HWViewer extends Task {
	public char[] sym = { '/', '-', '\\', '|' };
	public int index = 0;
	...
	static{
		...
		NtbDriverSPIScaraWorkaround.enableAxis(1);
		NtbDriverSPIScaraWorkaround.setSetValueAxis(1,0);
		
		
		HWViewer t = new HWViewer();
		t.period = 500;
		t.time = 100;
		Task.install(t);
	}
	...
	public void action(){
		...
		System.out.printHexln(NtbDriverSPIScaraWorkaround.tranceive(NtbDriversSPI.WHO_AM_I, 0, 0)&0xFFFF);
