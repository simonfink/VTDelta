#ifndef CH_NTB_SCARA_MOVE_FORCE_HPP_
#define CH_NTB_SCARA_MOVE_FORCE_HPP_
...
namespace scara{
	...
	public:
		Move(eeros::sequencer::Sequencer* sequencer, scara::ScaraControlSystem_force* controlSys, eeros::safety::SafetySystem* safetySys, scara::ScaraSafetyProperties_force* safetyProp);
