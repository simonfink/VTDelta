...
void PathPlanner::run() {
	...
	timestamp_t t = System::getTimeNs();
...
void PathPlanner::setVelMax(AxisVector velMax) { 
	 this->trajectoryGen.velMax = velMax; 
    }
void PathPlanner::setAccMax(AxisVector accMax) {
	 this->trajectoryGen.accMax = accMax;
	 this->trajectoryGen.decMax = -accMax;
    }
