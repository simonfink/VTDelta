...
GoToReady::GoToReady(Sequencer* sequencer, ScaraControlSystem* controlSys, SafetySystem* safetySys, ScaraSafetyProperties* safetyProp) : 
...
void GoToReady::run() {
	...
	AxisVector posUp; posUp << actPos_xyz(0), actPos_xyz(1), -0.105,  0;
