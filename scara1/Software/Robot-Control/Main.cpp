...
int main(int argc, char **argv) {
	...
	ScaraSafetyProperties safetyProperties;
	SafetySystem safetySystem(safetyProperties, dt);
	ScaraControlSystem controlSystem(safetySystem, safetyProperties);
...
// 	});
	...
	// Get Sequencer
	Sequencer sequencer;
	ScaraSequenceMain mainSequence(&sequencer, &controlSystem, &safetySystem, &safetyProperties);
