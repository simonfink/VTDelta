...
#include </home/ems-linux/Projects/ntb-scara/Software/Robot-Control/ScaraControlSystem.hpp>
...
ScaraDirectKinematic::ScaraDirectKinematic(double l1, double l2) : l1(l1), l2(l2) {
	...
	sampleTime = hal.getLogicOutput("sampleTime");
}
