#ifndef CH_NTB_SCARA_ENC_SAFETYPROPERTIES_HPP_
#define CH_NTB_SCARA_ENC_SAFETYPROPERTIES_HPP_
...
namespace scara{
	...
	class EncSafetyProperties : public eeros::safety::SafetyProperties {

		public:
		
			EncSafetyProperties(EncControlSystem* cs);
			virtual ~EncSafetyProperties();
...
#endif // CH_NTB_SCARA_ENC_SAFETYPROPERTIES_HPP_